...
class GetMedicinePlanHistoryUseCaseImplTest {

    private val plannedMedicineRepo: PlannedMedicineRepo = mock()

    private lateinit var useCase: GetMedicinePlanHistoryUseCase

    @Before
    fun before() {
        useCase = GetMedicinePlanHistoryUseCaseImpl(plannedMedicineRepo)
    }
