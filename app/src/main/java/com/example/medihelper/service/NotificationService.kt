...
class NotificationServiceImpl(context: Context) : NotificationService {
    ...
    private fun createServerSyncNotificationChannel(context: Context) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val channel =
                NotificationChannel(
                    SERVER_SYNC_CHANNEL_ID,
                    SERVER_SYNC_CHANNEL_NAME, importance)
