...
data class MedicinePlanEntityAndTimeDoseListAndMedicineEntityAndPlannedMedicineList(
    ...
    val plannedMedicineEntityList: List<PlannedMedicineEntity>
) {
    fun toMedicinePlanWithMedicineAndPlannedMedicines(imagesFiles: ImagesFiles) = MedicinePlanWithMedicineAndPlannedMedicines(
        ...
        plannedMedicineList = plannedMedicineEntityList.map { it.toPlannedMedicine() }
    )
}