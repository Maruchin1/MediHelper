...
data class HistoryItemData(
    ...
    data class CheckBox(
        ...
        companion object {
            ...
            fun fromDomainModel(model: HistoryItem.CheckBox) = CheckBox(
                plannedTime = model.plannedTime.formatString,
                statusColorId = getStatusColor(model.status)
            )
