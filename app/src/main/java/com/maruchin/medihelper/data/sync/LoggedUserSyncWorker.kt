...
import com.maruchin.medihelper.data.local.dao.*
import com.maruchin.medihelper.data.remote.api.RegisteredUserApi
import com.maruchin.medihelper.data.remote.dto.SyncRequestDto
import com.maruchin.medihelper.device.notifications.ServerSyncNotification
...
class LoggedUserSyncWorker(context: Context, params: WorkerParameters) :
    ...
    private val serverSyncNotification: ServerSyncNotification = ServerSyncNotification(context)
    ...
    override suspend fun doWork(): Result {
        serverSyncNotification.showServerSyncNotification()
        ...
        if (authToken != null) {
            try {
                ...
                e.printStackTrace()
                serverSyncNotification.showServerSyncFailNotification()
            }
        }
        serverSyncNotification.cancelServerSyncNotification()
        return result
    }
